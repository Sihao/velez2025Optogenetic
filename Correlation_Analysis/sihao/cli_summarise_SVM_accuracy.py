...
def main(input_path, output_path, overwrite=False):
    ...
    for fish_dir in fish_dirs:
        ...
        if os.path.exists(os.path.join(input_path, fish_dir, 'SVM_results', 'accuracy.npy')):
            accuracies.append(np.load(os.path.join(input_path, fish_dir, 'SVM_results', 'scaled_accuracy.npy')))
